...
public class AlbumPhotoAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.photo = (SquareImageView)convertView.findViewById(R.id.photo);
            viewHolder.transparent_bg = (SquareImageView)convertView.findViewById(R.id.transparent_bg);
            viewHolder.checkbox = (ImageView) convertView.findViewById(R.id.checkbox);
            viewHolder.indicatorView = (SectorIndicatorView) convertView.findViewById(R.id.indicator);
