...
public class Config {
   ...
   // public static final String STSSERVER = "http://0.0.0.0:0000/sts/getsts";//STS 地址
    //public static final String STSSERVER = "http://192.168.1.108:7080";//STS 地址
    public static final String STSSERVER = "http://192.168.1.108:7080";//STS 地址
    //public static final String STSSERVER = "http://172.18.211.231:7080";//STS 地址
    //public static final String uploadFilePath = "/storage/emulated/0/DCIM/Camera/IMG_20180311_224535.jpg"; //本地文件上传地址
    public static final String bucket = "biaoqingyun2";
   // public static final String bucket = "biaoqingyun3";
   // public static final String uploadObject = "1.ipg";
   // public static final String downloadObject = "test.txt";
